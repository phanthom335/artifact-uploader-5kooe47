        """
        Artifact Uploader 5kooe47
        =========================
        GitHub Actions-compatible script to automate repository housekeeping tasks.
        ...
        APP_NAME    = "Artifact Uploader 5kooe47"
        APP_VERSION = "1.0.0"
...
def _step_report(config, report):   pass  # TODO
        ...
        def build_parser() -> argparse.ArgumentParser:
            p = argparse.ArgumentParser(prog=APP_NAME, description="GitHub Actions-compatible script to automate repository housekeeping tasks.")
